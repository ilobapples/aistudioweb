      ...
      <div className="max-w-[1200px] mx-auto pt-32 pb-40 px-6">
        ...
        {project.processImages ? (
          <div className="space-y-40">
            {/* The Main Narrative Story of the Mockingbird Project */}
          ...
          <div className="flex flex-col items-center">
            {project.pdfUrl ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                 <img src={project.imageUrl} className="w-full shadow-2xl p-4 bg-white border border-zinc-100" alt={project.title} />
